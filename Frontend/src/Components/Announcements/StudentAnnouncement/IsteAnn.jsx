...
const GetstuIsteAnnouncements = () => {
  ...
  const fetchAnnouncements = async () => {
    ...
    try {
      ...
      const response = await axios.get("https://tech--connect.azurewebsites.net/api/iste/get/student", {
        headers: {
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white flex flex-col items-center p-6">
      ...
      >
        <h2 className="text-2xl font-bold text-center mb-4">ISTE Announcements</h2>
...
export default GetstuIsteAnnouncements;
