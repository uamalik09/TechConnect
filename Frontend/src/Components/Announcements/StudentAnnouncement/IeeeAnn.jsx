...
const GetstuIeeeAnnouncements = () => {
  ...
  const fetchAnnouncements = async () => {
    ...
    try {
      ...
      const response = await axios.get("https://tech--connect.azurewebsites.net/api/ieee/get/student", {
        headers: {
...
export default GetstuIeeeAnnouncements;
