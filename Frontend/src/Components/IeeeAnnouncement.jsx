...
const IeeeAnnouncements = () => {
  ...
  const fetchAnnouncements = async () => {
    try {
      const response = await axios.get(
        "http://localhost:8080/api/ieee/get"
      );
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white flex flex-col items-center p-6">
      ...
      >
        <h2 className="text-2xl font-bold text-center mb-4">IEEE Announcement</h2>
...
export default IeeeAnnouncements;
