...
const IetSig = () => {
  ...
  const clubs = [
    { 
      name: 'Abhivyakta', 
      path: '/abhivyakta/getacmdetails',
      image: '/images/abhivyakta.png',
    },
    { 
      name: 'Kaaryavarta', 
      path: '/kaaryavarta/getacmdetails',
      image: '/images/kaaryavarta.png',
    },
    { 
      name: 'Saahitya', 
      path: '/saahitya/getacmdetails',
      image: '/images/saahitya.png',
    },
    { 
      name: 'Sanganitra', 
      path: '/sanganitra/getacmdetails',
      image: '/images/sanganitra.png',
    },
    { 
      name: 'Vidyut', 
      path: '/vidyut/getacmdetails',
      image: '/images/vidyut.png',
    },
    { 
      name: 'Yantrika', 
      path: '/yantrika/getacmdetails',
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-gray-800 text-white">
      ...
      <nav className="bg-gray-800 px-6 py-4 shadow-lg border-b border-gray-700 sticky top-0 z-10">
        <div className="flex justify-between items-center">
          ...
          <div className="hidden md:flex">
            <Link to="/acmdashboard" className="hover:text-blue-400 flex items-center gap-2">
      ...
      <div className="bg-gradient-to-r from-blue-900 to-purple-900 py-8 px-6 text-center rounded-lg mx-4 sm:mx-8 mt-10 mb-10">
        ...
        <p className="max-w-2xl mx-auto text-gray-300">
          Select a SIG to get registered student details
        </p>
      </div>
