...
const SigChat = () => {
  ...
  const fetchMessages = async () => {
    try {
      ...
      const res = await fetch(`https://tech--connect.azurewebsites.net/api/doubts/4/${sigId}`, {
        method: "GET",
        headers: {
  ...
  try {
    ...
    const res = await fetch(
      `https://tech--connect.azurewebsites.net/api/doubts/4/${sigId}/admin/${doubtId}`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
