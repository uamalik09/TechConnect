...
// import { FaBullhorn, FaVideo, FaCalendarAlt, FaUserCircle, FaQuestionCircle, FaSignOutAlt } from "react-icons/fa";
// import { FaClipboardList, FaChartBar, FaTachometerAlt } from "react-icons/fa";
...
//                   <p className="text-xs bg-blue-500 rounded px-2 py-1 mt-2 inline-block">
//                     {userInfo.role}
//                   </p>
//                 </div>
//                 <div className="py-1">
...
//             <button
//               onClick={() => navigate("/acmannouncement")}
...
//             <button
//               onClick={() => navigate("/acminterviewslots")}
//               className="w-full bg-green-500 hover:bg-green-600 text-white py-2 rounded-lg transition"
//             >
//               Add
//             </button>
      ...
      <div className="container mx-auto py-10 px-6">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-400 mt-4 max-w-xl mx-auto">
            Welcome to the ACM admin panel. Manage announcements, talks, interviews, and more from one place.
          </p>
        </div>
