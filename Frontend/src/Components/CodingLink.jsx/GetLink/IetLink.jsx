...
//       <h1 className="text-2xl font-bold mb-4 mt-5">Available Tests</h1>
...
//           <li key={link.id || index} className="mb-3">
//             <a
//               href={link.url}
//               target="_blank"
//               rel="noopener noreferrer"
//               className="block p-3 bg-white shadow rounded text-blue-600 text-center hover:bg-blue-50 transition"
//             >
//               Test {index + 1}
//             </a>
//           </li>
