...
router.get("/iet/getcode", authenticateUser, authorizeRoles("iet"), (req, res) => getLinks(req, res, "ietCoding"));
...
router.get("/iet/getcode/student", authenticateUser, authorizeRoles("user"), (req, res) => getLinks(req, res, "ietCoding"));

router.post("/ieee/addcode", authenticateUser, authorizeRoles("ieee"), (req, res) => addLink(req, res, "ieeeCoding"));
router.get("/ieee/getcode", authenticateUser, authorizeRoles("ieee"), (req, res) => getLinks(req, res, "ieeeCoding"));
...
router.get("/ieee/getcode/student", authenticateUser, authorizeRoles("user"), (req, res) => getLinks(req, res, "ieeeCoding"));

router.post("/acm/addcode", authenticateUser, authorizeRoles("acm"), (req, res) => addLink(req, res, "acmCoding"));
router.get("/acm/getcode", authenticateUser, authorizeRoles("acm"), (req, res) => getLinks(req, res, "acmCoding"));
...
router.get("/acm/getcode/student", authenticateUser, authorizeRoles("user"), (req, res) => getLinks(req, res, "acmCoding"));

router.post("/ie/addcode", authenticateUser, authorizeRoles("ie"), (req, res) => addLink(req, res, "ieCoding"));
router.get("/ie/getcode", authenticateUser, authorizeRoles("ie"), (req, res) => getLinks(req, res, "ieCoding"));
...
router.get("/ie/getcode/student", authenticateUser, authorizeRoles("user"), (req, res) => getLinks(req, res, "ieCoding"));

router.post("/iste/addcode", authenticateUser, authorizeRoles("iste"), (req, res) => addLink(req, res, "isteCoding"));
router.get("/iste/getcode", authenticateUser, authorizeRoles("iste"), (req, res) => getLinks(req, res, "isteCoding"));
...
router.get("/iste/getcode/student", authenticateUser, authorizeRoles("user"), (req, res) => getLinks(req, res, "isteCoding"));
