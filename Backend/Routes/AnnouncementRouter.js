...
router.get("/iet/get", authenticateUser, authorizeRoles("iet", "user"), (req, res) => getAnnouncements(req, res, "ietAnnouncement"));
...
router.get("/ieee/get", authenticateUser, authorizeRoles("ieee", "user"), (req, res) => getAnnouncements(req, res, "ieeeAnnouncement"));
...
router.get("/acm/get", authenticateUser, authorizeRoles("acm", "user"), (req, res) => getAnnouncements(req, res, "acmAnnouncement"));
...
router.get("/ie/get", authenticateUser, authorizeRoles("ie", "user"), (req, res) => getAnnouncements(req, res, "ieAnnouncement"));
...
router.get("/iste/get", authenticateUser, authorizeRoles("iste", "user"), (req, res) => getAnnouncements(req, res, "isteAnnouncement"));
