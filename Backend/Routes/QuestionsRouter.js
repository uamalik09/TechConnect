...
router.get("/acm/sanganitra/get", authenticateUser, authorizeRoles("acm", "user"), (req, res) => getQuestions(req, res, "acmsanganitra"));
...
router.get("/acm/kaaryavarta/get", authenticateUser, authorizeRoles("acm", "user"), (req, res) => getQuestions(req, res, "acmkaaryavarta"));
...
router.get("/acm/vidyut/get", authenticateUser, authorizeRoles("acm", "user"), (req, res) => getQuestions(req, res, "acmvidyut"));
...
router.get("/acm/yantrika/get", authenticateUser, authorizeRoles("acm", "user"), (req, res) => getQuestions(req, res, "acmyantrika"));
...
router.get("/acm/saahitya/get", authenticateUser, authorizeRoles("acm", "user"), (req, res) => getQuestions(req, res, "acmsaahitya"));
...
router.get("/acm/abhivyakta/get", authenticateUser, authorizeRoles("acm", "user"), (req, res) => getQuestions(req, res, "acmabhivyakta"));
...
router.get("/iste/catalyst/get", authenticateUser, authorizeRoles("iste", "user"), (req, res) => getQuestions(req, res, "istecatalyst"));
...
router.get("/iste/charge/get", authenticateUser, authorizeRoles("iste", "user"), (req, res) => getQuestions(req, res, "istecharge"));
...
router.get("/iste/chronicle/get", authenticateUser, authorizeRoles("iste", "user"), (req, res) => getQuestions(req, res, "istechronicle"));
...
router.get("/iste/clutch/get", authenticateUser, authorizeRoles("iste", "user"), (req, res) => getQuestions(req, res, "isteclutch"));
...
router.get("/iste/concrete/get", authenticateUser, authorizeRoles("iste", "user"), (req, res) => getQuestions(req, res, "isteconcrete"));
...
router.get("/iste/create/get", authenticateUser, authorizeRoles("iste", "user"), (req, res) => getQuestions(req, res, "istecreate"));
...
router.get("/iste/credit/get", authenticateUser, authorizeRoles("iste", "user"), (req, res) => getQuestions(req, res, "istecredit"));
...
router.get("/iste/crypt/get", authenticateUser, authorizeRoles("iste", "user"), (req, res) => getQuestions(req, res, "istecrypt"));
